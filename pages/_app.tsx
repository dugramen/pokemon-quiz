...
export default function MyApp({ Component, pageProps }) {
  ...
  // const [generations, setGenerations] = useState(allGenerations)
  const [generations, setGenerations] = useState([] as number[])
  
  useEffect(() => {
    const gens = allGenerations.filter((gen) => localStorage.getItem(`gen-${gen}`) === 'true');
    console.log("local gens ", gens)
    setGenerations(gens)
  }, [router.pathname])
  ...
  return (
    <PokeList.Provider value={pokes}>
      <GenerationsContext.Provider value={{generations, setGenerations}}>
